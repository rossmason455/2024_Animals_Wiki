            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <x-family-detail :family_name="$family->family_name" :characteristics="$family->characteristics"
                            :evolutionary_origin="$family->evolutionary_origin" :family_image="$family->image_url" />
